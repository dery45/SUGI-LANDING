  ...
  const content = isID
    ? {
        ...
        steps: [
          ...
          { step: '05', title: 'LLM On-Premise (SUGI Llama 3.6)', desc: 'Model SUGI Llama 3.6 Hybrid RAG berjalan lokal via Ollama. Data tetap aman di infrastruktur Indonesia — biaya inferensi tidak bertambah seiring pengguna. Didukung Qwen 2.5 sebagai utility LLM, persistent memory, dan pengamanan berlapis (UU PDP).' },
    ...
    : {
        ...
        steps: [
          ...
          { step: '05', title: 'On-Premise LLM (SUGI Llama 3.6)', desc: 'SUGI Llama 3.6 Hybrid RAG model running locally via Ollama. Data stays secure in Indonesian infrastructure — inference costs don\'t increase with users. Supported by Qwen 2.5 utility LLM, persistent memory, and layered security (PDP Law).' },

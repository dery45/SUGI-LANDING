...
const roadmap = {
  id: [
    { period: '01 Mar–26 Mar 2026', title: 'Fase 1: Chatbot dan Front End Dashboard', desc: 'Chatbot: Fondasi Hybrid RAG (BM25 + Vector Search) dengan LLM lokal (on-premise). Dashboard: Manajemen siklus tanam (CRUD) dan visualisasi peta dasar.' },
    { period: '01 Mei–04 Jun 2026', title: 'Fase 2: Offline Catch-up dan Back End Dashboard', desc: 'Chatbot: Bot Telegram live dengan fitur Offline Catch-up (zero data loss). Dashboard: Frontend & backend terhubung, 14 modul data, dan peta interaktif. Integrasi: Daily Insight Engine mulai mengirim insight harian ke dashboard.' },
    { period: '19 Jun–26 Jul 2026', title: 'Fase 3: Integrasi dan Optimisasi', desc: 'Chatbot: AI Insight Engine otomatis untuk petani dan pemerintah dengan change detection. Dashboard: 15 tab analitik NLP (Knowledge Graph, Sentimen, Tren) dan arsitektur dual-database. Performa & Data: Optimasi 15 query paralel, cache 5 menit, kompresi data 80%, serta integrasi 15+ dataset ketahanan pangan nasional. Pengembangan PWA untuk mobile.' },
  ],
  en: [
    { period: '01 Mar–26 Mar 2026', title: 'Phase 1: Chatbot and Front End Dashboard', desc: 'Chatbot: Hybrid RAG foundation (BM25 + Vector Search) with local LLM (on-premise). Dashboard: Cultivation cycle management (CRUD) and basic map visualization.' },
    { period: '01 May–04 Jun 2026', title: 'Phase 2: Offline Catch-up and Back End Dashboard', desc: 'Chatbot: Live Telegram bot with Offline Catch-up feature (zero data loss). Dashboard: Frontend & backend connected, 14 data modules, and interactive map. Integration: Daily Insight Engine starts sending daily insights to dashboard.' },
    { period: '19 Jun–26 Jul 2026', title: 'Phase 3: Integration and Optimization', desc: 'Chatbot: Automated AI Insight Engine for farmers and government with change detection. Dashboard: 15 NLP analytics tabs (Knowledge Graph, Sentiment, Trends) and dual-database architecture. Performance & Data: 15 parallel query optimization, 5-min cache, 80% data compression, and 15+ national food security dataset integration. PWA mobile development.' },
  ],
}

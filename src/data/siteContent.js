export const content = {
      ...
      points: [
        {
          ...
          desc: 'Chatbot AI hybrid RAG yang memahami konteks pertanian Indonesia, memberikan rekomendasi tanam, analisis harga, peringatan dini cuaca, deteksi hama, serta saran waktu jual berdasarkan data harga dan cuaca secara real-time.',
        },
        {
          title: 'Transfer Pengetahuan Lintas Generasi',
          desc: 'Knowledge base yang terus belajar dari setiap interaksi, menjembatani pengetahuan empiris petani senior dengan akses data digital untuk generasi muda, menghentikan krisis regenerasi secara sistemik.',
        },
        {
          title: 'Early Warning System Berbasis Data',
          desc: 'Data mikro lapangan dikonversi menjadi intelijen kebijakan pangan nasional secara berkelanjutan — mempercepat respons pemerintah dari skala minggu ke hari, memungkinkan intervensi GPM (Gerakan Pangan Murah) yang lebih cepat dan tepat sasaran.',
        },
        {
          title: 'Kedaulatan Data & Privasi',
          desc: 'Seluruh proses inferensi AI berjalan on-premise via Ollama. Data operasional petani, perusahaan, dan pemerintah tidak pernah dikirim ke layanan AI publik. Kepatuhan penuh terhadap UU PDP No. 27/2022.',
        },
        {
        ...
        {
          title: 'Data Flywheel',
          desc: 'Semakin banyak petani menggunakan SUGI, semakin kaya data lapangan dan percakapan, semakin akurat Hybrid RAG, semakin tinggi nilai analitik dashboard — siklus yang saling memperkuat dengan rasio LTV/CAC 13,7×.',
        },
      ],
    },
    en: {
      ...
      points: [
        {
          ...
          desc: 'Hybrid RAG AI chatbot that understands Indonesian agricultural context, providing planting recommendations, price analysis, weather early warnings, pest detection, and selling time advice based on real-time price and weather data.',
        },
        {
          title: 'Cross-Generational Knowledge Transfer',
          desc: 'A knowledge base that continuously learns from every interaction, bridging senior farmers\' empirical knowledge with digital data access for younger generations, systematically stopping the regeneration crisis.',
        },
        {
          title: 'Data-Driven Early Warning System',
          desc: 'Micro-level field data is converted into national food security intelligence on an ongoing basis — accelerating government response from weeks to days, enabling faster and more targeted GPM (Affordable Food Movement) interventions.',
        },
        {
          title: 'Data Sovereignty & Privacy',
          desc: 'All AI inference runs on-premise via Ollama. Farmer, company, and government operational data is never sent to public AI services. Full compliance with PDP Law No. 27/2022.',
        },
        {
          title: 'Cross-Subsidy Model',
          desc: 'Free Telegram chatbot for farmers as an adoption channel. Funded through B2B SaaS (Farmer Groups IDR 400K/mo, Agribusiness IDR 1M/mo, Government IDR 1.75M/mo) and Data-as-a-Service for research institutions.',
        },
        {
          title: 'Data Flywheel',
          desc: 'The more farmers use SUGI, the richer the field data and conversations, the more accurate the Hybrid RAG, the higher the dashboard analytics value — a self-reinforcing cycle with 13.7× LTV/CAC ratio.',
        },
      ],
    },
  },
  ...
  ecosystem: {
    id: {
      ...
      subtitle: 'Empat komponen yang beroperasi sebagai satu AI Engine — menghubungkan interaksi lapangan petani menjadi intelijen kebijakan pangan nasional secara berkelanjutan.',
      items: [
        {
          title: 'SUGI AI Core',
          subtitle: 'Asisten Cerdas Hybrid RAG',
          desc: 'Chatbot Telegram berbasis Hybrid RAG (BM25 + Dense Vector + Cross-Encoder) yang berjalan on-premise via Ollama. Menjawab pertanyaan budidaya, harga, cuaca, dan hama secara real-time dengan konteks pertanian Indonesia. Zero recurring cost.',
          features: ['Scope Guard & Query Rewriting 3-Layer', 'Cross-Encoder Reranker', 'Long-Term Memory', '100% Gratis untuk Petani'],
        },
        {
          title: 'SUGIDash',
          subtitle: 'Dashboard Analitik & Intelijen Pangan',
          desc: 'Platform dashboard MERN Stack untuk tiga peran (Petani, Manajemen, Pemerintah) dengan 15+ dataset ketahanan pangan nasional, lifecycle tracker, KPI finansial real-time, dan modul Chatbot Insight berbasis NLP.',
          features: ['3 Role-Based Dashboard', '15+ Dataset Bapanas/BPS', 'Lifecycle Management', 'Chatbot Insight NLP'],
        },
        {
          title: 'SUGI PWA',
          subtitle: 'Aplikasi Lapangan Mobile-First Offline-First',
          desc: 'Aplikasi mobile untuk pencatatan aktivitas budidaya di area sinyal terbatas. Sinkronisasi data otomatis saat online. Terintegrasi langsung dengan SUGI AI dan SUGIDash dalam satu pipeline data.',
          features: ['Offline-First', 'Pencatatan Lapangan', 'Sinkronisasi Otomatis', 'Minimum Typing UX'],
        },
        {
          title: 'Daily Insight Engine',
          subtitle: 'Mesin Wawasan Otomatis',
          desc: 'Layanan cron 12 jam yang mengagregasi interaksi mikro dari ketiga komponen menjadi wawasan makro terstruktur — harga, cuaca, rekomendasi tanam, tren kebijakan, dan ringkasan sesi. Mendukung Early Warning System pemerintah.',
          features: ['Daily Insights (12 jam)', 'Government Insights (3600s)', 'Farmer Insights (10 jenis)', 'Policy Recommendations'],
        },
      ],
      flowNote: 'Keempat komponen terhubung dalam satu pipeline data — dari interaksi lapangan petani menjadi intelijen kebijakan pangan nasional secara berkelanjutan.',
    },
    en: {
      title: 'SUGI Ecosystem',
      subtitle: 'Four components operating as one AI Engine — connecting on-field farmer interactions into national food security intelligence on an ongoing basis.',
      items: [
        {
          title: 'SUGI AI Core',
          subtitle: 'Hybrid RAG Intelligent Assistant',
          desc: 'Telegram chatbot powered by Hybrid RAG (BM25 + Dense Vector + Cross-Encoder) running on-premise via Ollama. Answers cultivation, pricing, weather, and pest queries in real-time with Indonesian agricultural context. Zero recurring cost.',
          features: ['Scope Guard & 3-Layer Rewriting', 'Cross-Encoder Reranker', 'Long-Term Memory', '100% Free for Farmers'],
        },
        {
          title: 'SUGIDash',
          subtitle: 'Analytics & Food Intelligence Dashboard',
          desc: 'MERN Stack dashboard platform for three roles (Farmer, Management, Government) with 15+ national food security datasets, lifecycle tracker, real-time financial KPIs, and NLP-based Chatbot Insight module.',
          features: ['3 Role-Based Dashboards', '15+ Bapanas/BPS Datasets', 'Lifecycle Management', 'Chatbot Insight NLP'],
        },
        {
          title: 'SUGI PWA',
          subtitle: 'Mobile-First Offline-First Field App',
          desc: 'Mobile app for recording cultivation activities in limited signal areas. Auto data sync when online. Directly integrated with SUGI AI and SUGIDash in one data pipeline.',
          features: ['Offline-First', 'Field Recording', 'Auto Sync', 'Minimum Typing UX'],
        },
        {
          title: 'Daily Insight Engine',
          subtitle: 'Automated Intelligence Engine',
          desc: '12-hour cron service aggregating micro interactions from all three components into structured macro insights — prices, weather, planting recommendations, policy trends, and session summaries. Supports government Early Warning System.',
          features: ['Daily Insights (12h)', 'Government Insights (3600s)', 'Farmer Insights (10 types)', 'Policy Recommendations'],
        },
      ],
      flowNote: 'All four components are connected in one data pipeline — from farmer field interaction to national food security intelligence on an ongoing basis.',
    },
  },
  features: {
    id: {
      ...
      categories: [
        ...
        },
        {
          ...
          items: [
            'Hybrid RAG dengan akurasi 94/100 — BM25 + Vector + Cross-Encoder',
            ...
            'Early Warning System real-time untuk deteksi kerawanan pangan & fluktuasi harga',
          ],
        },
      ],
    },
    en: {
      ...
      categories: [
        ...
        },
        {
          ...
          items: [
            'Hybrid RAG with 94/100 accuracy — BM25 + Vector + Cross-Encoder',
            ...
            'Real-time Early Warning System for food insecurity & price fluctuation detection',
          ],
        },
      ],
    },
  ...
  about: {
    id: {
      ...
      story: [
        'Berawal dari implementasi sistem smart farming dan manajemen kelompok tani di Wonoboyo, Jogonalan, Klaten bersama Universitas Negeri Yogyakarta pada tahun 2024, SUGI dikembangkan untuk menjawab kebutuhan petani yang melampaui sekadar digitalisasi — mereka membutuhkan pendamping pengambilan keputusan yang kontekstual dan responsif terhadap kondisi lapangan aktual.',
        ...
        'Dari temuan tersebut, lahirlah SUGI: Sistem Untuk Generasi Intelejen — ekosistem AI pertanian yang menggabungkan chatbot cerdas (Hybrid RAG), dashboard analitik (SUGIDash), aplikasi lapangan (SUGI PWA), dan mesin wawasan otomatis (Insight Engine) dalam satu platform terintegrasi yang mengonversi interaksi lapangan petani menjadi intelijen kebijakan pangan nasional.',
      ],
      mission: 'Misi kami adalah mendemokratisasi akses informasi pertanian bagi seluruh petani Indonesia, menjembatani kesenjangan pengetahuan lintas generasi, dan mendukung ketahanan pangan nasional melalui kecerdasan buatan yang berdaulat dan terjangkau — dengan model cross-subsidy yang memastikan AI tetap gratis bagi petani.',
    },
    en: {
      title: 'About Us',
      ...
      story: [
        'Starting from a smart farming system implementation with farmer groups in Wonoboyo, Jogonalan, Klaten in collaboration with Yogyakarta State University in 2024, SUGI was developed to address farmers\' needs beyond mere digitalization — they need contextual decision support that responds to actual field conditions.',
        ...
        'From these findings, SUGI was born: Intelligent Generation System — an agricultural AI ecosystem combining intelligent chatbot (Hybrid RAG), analytics dashboard (SUGIDash), field application (SUGI PWA), and automated insight engine (Insight Engine) in one integrated platform that converts farmer field interactions into national food security intelligence.',
      ],
      mission: 'Our mission is to democratize access to agricultural information for all Indonesian farmers, bridge the cross-generational knowledge gap, and support national food security through sovereign and affordable artificial intelligence — with a cross-subsidy model ensuring AI remains free for farmers.',
    },
  },
  footer: {
    id: {

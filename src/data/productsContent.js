export const productPages = {
  ...
  aiArchitecture: {
    ...
    pipeline: [
      ...
      { title: { id: 'LLM sugi-v0.1L (Ollama)', en: 'LLM sugi-v0.1L (Ollama)' }, desc: { id: 'Model LLaMA 3.2 fine-tuned untuk Bahasa Indonesia pertanian. Berjalan lokal, data aman, biaya tetap.', en: 'LLaMA 3.2 fine-tuned for Indonesian agricultural language. Runs locally, data secure, fixed cost.' }, meta: 'On-Premise' },
